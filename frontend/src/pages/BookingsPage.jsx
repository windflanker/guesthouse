...
export default function BookingsPage() {
  ...
  const openReject = (booking) => { setActionDone(false); resetConfirmed(); setModal({ type: 'reject', booking }); };
  ...
  const openCancel = (booking) => { setFormData({ cancelReason: '' }); setActionDone(false); resetConfirmed(); setModal({ type: 'cancel', booking }); };
        ...
        <Modal title="Reject booking" onClose={closeModal}>
          {!actionDone ? (
            ...
            <>
              ...
              />
              <ModalActions>
                <button style={s.mBtn('blue')} onClick={closeModal}>{guestConfirmed ? '✓ Done — Message Sent' : 'Done'}</button>
              </ModalActions>
            </>
          )}
        </Modal>

...
export default function Layout() {
  ...
  return (
    <div style={s.shell}>
      ...
      {/* Mobile top bar */}
      <div id="topbar" style={s.topBar}>
        <div style={s.topBarLeft} onClick={() => navigate('/admin')}>
      ...
      {menuOpen && (
        <div id="mobilemenu" style={s.mobileMenu}>
          {navItems.map(item => (
...
const s = {
  ...
  topBar:       { position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, background: '#fff', borderBottom: '0.5px solid rgba(0,0,0,0.1)', padding: '10px 16px', alignItems: 'center', justifyContent: 'space-between' },
  ...
  menuBtn:      { background: 'none', border: 'none', fontSize: 22, color: '#1A1917', cursor: 'pointer', padding: '2px 6px' },
  mobileMenu:   { position: 'fixed', top: 52, left: 0, right: 0, zIndex: 99, background: '#fff', borderBottom: '0.5px solid rgba(0,0,0,0.1)', flexDirection: 'column', padding: '8px 12px 16px', boxShadow: '0 8px 24px rgba(0,0,0,0.08)' },
  mobileNavLink:{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 12px', borderRadius: 10, fontSize: 15, color: '#5A5855', fontWeight: 400, marginBottom: 2 },
  mobileNavActive: { background: '#E6F1FB', color: '#185FA5', fontWeight: 500 },
  mobileExtLink:{ fontSize: 13, color: '#185FA5', padding: '10px 12px', border: '0.5px solid rgba(0,0,0,0.18)', borderRadius: 10, display: 'block', textAlign: 'center', marginTop: 8, marginBottom: 8 },
  mobileAdminRow:{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 12px 0', borderTop: '0.5px solid rgba(0,0,0,0.08)' },
  sidebar:      { width: 220, flexShrink: 0, background: '#fff', borderRight: '0.5px solid rgba(0,0,0,0.1)', display: 'flex', flexDirection: 'column', padding: '0 0 16px' },
  logoBox:      { display: 'flex', alignItems: 'center', gap: 10, padding: '16px 20px', borderBottom: '0.5px solid rgba(0,0,0,0.08)', marginBottom: 8, cursor: 'pointer' },
  ...
  navLink:      { display: 'flex', alignItems: 'center', gap: 10, padding: '8px 12px', borderRadius: 10, fontSize: 14, color: '#5A5855', transition: 'all 0.15s', fontWeight: 400 },
  ...
  externalLink: { fontSize: 12, color: '#185FA5', padding: '8px 12px', border: '0.5px solid rgba(0,0,0,0.18)', borderRadius: 10, display: 'block', textAlign: 'center' },
  adminRow:     { display: 'flex', alignItems: 'center', gap: 8, padding: '10px 4px 0', borderTop: '0.5px solid rgba(0,0,0,0.08)' },
  avatar:       { width: 28, height: 28, borderRadius: '50%', background: '#E6F1FB', color: '#185FA5', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 500 },
